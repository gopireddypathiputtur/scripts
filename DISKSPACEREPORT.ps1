...
# EMAIL PROPERTIES
	# Set the recipients of the report.
		$users = "IMS_Wintel_Support@birlasoft.com", "subhashchandra.dube@croma.com"
  		#$users = "yogesh.dhangar@birlasoft.com" # I use this for testing by uing my email address.
		#$users = "kpit_office365_l2@infinitiretail.com", "santosh.gavade@kpit.com", "yogesh.dhangar@kpit.com";  # can be sent to individuals.


# REPORT PROPERTIES
	# Path to the report
		$reportPath = "C:\Scripts\Disc-Report\Reports";
...
$header = "
		...
		<font face='tahoma' color='#003399' size='4'><strong>Croma Environment DiskSpace Report for $titledate</strong></font>
		</td>
		</tr>
		</table>
"
...
# Create table at end of report showing legend of colors for the critical and warning
 $tableDescription = "
	...
	<tr bgcolor='White'>
    <td width='10%' align='center' bgcolor='#FBB917'>Warning less than 60% free space</td>
    ...
    foreach ($user in $users)
{
		...
		$smtpServer = "10.11.54.46"
		$smtp = New-Object Net.Mail.SmtpClient($smtpServer)
		$msg = New-Object Net.Mail.MailMessage
		$msg.To.Add($user)
        $msg.From = "irl.apps@infinitiretail.com"
